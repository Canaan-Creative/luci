...
t1:option(DummyValue, "mhsav", translate("MHS av"))
t1:option(DummyValue, "mhs5s", translate("MHS 5s"))
t1:option(DummyValue, "lvw", translate("Last Valid Work"))
...
t1:option(DummyValue, "lw", translate("Local works"))
